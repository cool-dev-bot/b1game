...
function LandingPage() {
    ...
    return (
        <>
           <motion.div
      className="max-w-full mx-auto font-['oswald'] px-3 sm:px-4 md:px-8"
      initial="hidden"
      animate="visible"
    ...
    >
      {/* deposit */}
      {outlet[3] && (
        <Deposit setBtcDespositPopUp={setBtcDespositPopUp} setDespositPopUp={outlet[2]} setWithdraw={setWithdraw} setTokenDespositPopUp={setTokenDespositPopUp} />
      )}
      {btcDepositPopUp && (
        <BtcDeposit setBtcDespositPopUp={setBtcDespositPopUp} setDespositPopUp={outlet[2]} setTokenDespositPopUp={setTokenDespositPopUp} setWithdraw={setWithdraw} />
      )}
      {TokenDepositPopUp && (
        <TokenDeposit setBtcDespositPopUp={setBtcDespositPopUp} setTokenDespositPopUp={setTokenDespositPopUp} setDespositPopUp={outlet[2]} setWithdraw={setWithdraw} />
      )}
      {/* deposit */}

      {/* withdraw */}
      {withDraw === 'withdraw' && <Withdraw setWithdraw={setWithdraw} setDespositPopUp={outlet[2]} />}
      {withDraw === 'btcwithdraw' && <BtcWithdraw setWithdraw={setWithdraw} setDespositPopUp={outlet[2]} />}
      {withDraw === 'tokenwithdraw' && <TokenWithdraw setWithdraw={setWithdraw} setDespositPopUp={outlet[2]} />}
      {/* withdraw */}
